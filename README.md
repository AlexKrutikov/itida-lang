...
- **Подключение библиотек функций Айтиды** — автодополнение, hover и подсказки параметров для функций из выгруженных библиотек
...
```bash
code --install-extension itida-lang-0.1.3.vsix
```
